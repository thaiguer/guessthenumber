...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2023013538407234166, ; hash 0x1c1330184491ba76, from name: aot-GuessTheNumber.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-GuessTheNumber.dll.so
		ptr null; void* handle (0x0)
	}, ; 44
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3046351616613049847, ; hash 0x2a46d0a7b12865f7, from name: GuessTheNumber.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-GuessTheNumber.dll.so
		ptr null; void* handle (0x0)
	}, ; 77
	...
	%struct.DSOCacheEntry {
		i64 7181344876046179776, ; hash 0x63a9431dca4dddc0, from name: libaot-GuessTheNumber
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-GuessTheNumber.dll.so
		ptr null; void* handle (0x0)
	}, ; 164
	...
	%struct.DSOCacheEntry {
		i64 7375091762488279028, ; hash 0x665996e21105fff4, from name: aot-GuessTheNumber
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-GuessTheNumber.dll.so
		ptr null; void* handle (0x0)
	}, ; 172
	...
	%struct.DSOCacheEntry {
		i64 13723156025745752057, ; hash 0xbe7271b26fd63ff9, from name: libaot-GuessTheNumber.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-GuessTheNumber.dll.so
		ptr null; void* handle (0x0)
	}, ; 354
	...
	%struct.DSOCacheEntry {
		i64 15415409581910353241, ; hash 0xd5ee895724eb6559, from name: GuessTheNumber
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-GuessTheNumber.dll.so
		ptr null; void* handle (0x0)
	}, ; 401
...
@.env.3 = private unnamed_addr constant [37 x i8] c"0285f4f8-35d5-42fc-bd6b-2905afe086f0\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [29 x i8] c"libaot-GuessTheNumber.dll.so\00", align 16
