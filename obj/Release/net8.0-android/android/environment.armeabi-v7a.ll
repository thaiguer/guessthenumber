...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 117260953, ; hash 0x6fd4299, from name: aot-GuessTheNumber
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 903911371, ; hash 0x35e097cb, from name: libaot-GuessTheNumber.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-GuessTheNumber.dll.so
		ptr null; void* handle (0x0)
	}, ; 96
	...
	%struct.DSOCacheEntry {
		i64 987700127, ; hash 0x3adf1b9f, from name: GuessTheNumber.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-GuessTheNumber.dll.so
		ptr null; void* handle (0x0)
	}, ; 101
	...
	%struct.DSOCacheEntry {
		i64 1952628872, ; hash 0x7462c088, from name: GuessTheNumber
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-GuessTheNumber.dll.so
		ptr null; void* handle (0x0)
	}, ; 207
	...
	%struct.DSOCacheEntry {
		i64 2627177297, ; hash 0x9c978b51, from name: aot-GuessTheNumber.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-GuessTheNumber.dll.so
		ptr null; void* handle (0x0)
	}, ; 297
	...
	%struct.DSOCacheEntry {
		i64 3916009244, ; hash 0xe9698f1c, from name: libaot-GuessTheNumber
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-GuessTheNumber.dll.so
		ptr null; void* handle (0x0)
	}, ; 436
